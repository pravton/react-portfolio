      ...
      <div className="history-container">
        <div className="history">
          ...
          <div className="work-history">
            ...
            <p>3 <span className="sp-ml3"> <span className="sp-red">{`title`}</span> : <span className="sp-green">{`"Web Developer II"`}</span>,</span></p>
            <p>4 <span className="sp-ml3"> <span className="sp-red">{`company`}</span> : <span className="sp-green">{`"Q4"`}</span>,</span></p>
            <p>5 <span className="sp-ml3"> <span className="sp-red">{`yearsExperience`}</span> : <span className="sp-orange">1</span>,</span></p>
            <p>6 <span className="sp-ml3"> <span className="sp-red">{`location`}</span> : <span className="sp-green">{`"Hamilton"`}</span>,</span></p>
            <p>7 <span className="sp-ml2"> <span className="sp-purple">{`}`}</span>,</span></p>
            <p>8 <span className="sp-purple sp-ml2">{`{`}</span></p>
            <p>9 <span className="sp-ml3"> <span className="sp-red">{`title`}</span> : <span className="sp-green">{`"Web Developer"`}</span>,</span></p>
            <p>10 <span className="sp-ml4"> <span className="sp-red">{`company`}</span> : <span className="sp-green">{`"Innomactic"`}</span>,</span></p>
            <p>11 <span className="sp-ml4"> <span className="sp-red">{`yearsExperience`}</span> : <span className="sp-orange">2</span>,</span></p>
            <p>12 <span className="sp-ml4"> <span className="sp-red">{`location`}</span> : <span className="sp-green">{`"Toronto"`}</span>,</span></p>
